...
<html>
    ...
    <body>
        ...
        <form action='processFeedback.jsp?id=<c:out value="${id}"/>' method="post">
        <table align="center" border="1">
            ...
            <tr>
                ...
                <td><textarea name="fb" cols='30' rows="6" style="resize: none" placeholder="Input feedback here."></textarea></td>
            </tr>
        </table>
        <br>        
