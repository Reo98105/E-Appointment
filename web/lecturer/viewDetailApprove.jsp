...
<html>
    ...
    <body>
        ...
        <c:set var="app" value="${appDao.getAppointByStd(id)}"/>
        <table align="center" border="1">
            ...
            <div class="button-container">
                <form action="processApprove.jsp?id=<c:out value="${param.id}"/>" method="post">
                    <div>
                        <input type="submit" value="Approve"/>
                    </div>
                </form>
                    <form action="processReject.jsp?id=<c:out value="${param.id}"/>" method="post">
                    <div>
